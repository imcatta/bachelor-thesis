...
\pdfinfo{%
  /Title    (Un approccio alla Time-Lock Encryption basato su Smart Contract)
...
% \frontespizio
\includepdf[fitpaper=true]{frontespizio/fronteingegnerialm.pdf}
\shipout\null
\shipout\null
...
\include{chapters/chap_tle}
\include{chapters/chap_protocollo}
\include{chapters/chap_poc}
\include{chapters/chap_dimensionamento}
\include{chapters/chap_analisi_attacchi}
\include{chapters/chap_possibili_usi}
